                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2 text-xs mb-2">
                                                <div className="bg-slate-50 p-1.5 rounded border border-slate-100 flex-1 min-w-0">
                                                    <span className="text-slate-400 block text-[9px] uppercase font-bold mb-0.5 truncate">Height</span>
                                                    <span className="font-mono text-slate-700 font-bold text-[10px] truncate block">{robot.height.split('(')[0]}</span>
                                                </div>
                                                <div className="bg-slate-50 p-1.5 rounded border border-slate-100 flex-1 min-w-0">
                                                    <span className="text-slate-400 block text-[9px] uppercase font-bold mb-0.5 truncate">Weight</span>
                                                    <span className="font-mono text-slate-700 font-bold text-[10px] truncate block">{robot.weight.split('(')[0]}</span>
                                                </div>
                                                <div className="bg-slate-50 p-1.5 rounded border border-slate-100 flex-[1.5] flex flex-col justify-center min-w-0">
                                                    <span className="text-slate-400 block text-[9px] uppercase font-bold mb-0.5 truncate">Compute</span>
                                                    <span className="font-mono text-slate-700 font-bold text-[10px] truncate block" title={robot.compute}>
