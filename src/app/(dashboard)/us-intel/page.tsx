...
const AGENCY_PROFILES: Record<string, any> = {
    ...
    DOD: {
        name: 'Department of Defense (DOD) / Dept. of War',
        acronym: 'DOD',
        founded: '1947',
                        ...
                        <div className="bg-white rounded-2xl shadow-sm overflow-hidden min-h-[600px]">
                            ...
                            {loading && feedItems.length === 0 ? (
                                <div className="p-12 flex flex-col items-center justify-center text-slate-400">
                                    ...
                                    <span className="text-xs font-mono uppercase tracking-widest mb-1">Establishing Secure Uplink...</span>
                                    <span className="text-[10px] font-mono text-slate-300 uppercase tracking-wider">Processing 109+ agency sources</span>
                                </div>
                            ) : feedItems.length === 0 ? (
                                <div className="p-12 flex flex-col items-center justify-center text-slate-400">
