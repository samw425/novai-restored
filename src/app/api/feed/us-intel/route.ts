...
const FEEDS = {
    ...
    DOJ: 'https://news.google.com/rss/search?q=site:justice.gov/news&hl=en-US&gl=US&ceid=US:en', // Switched to site search (403 fix)
    WHITE_HOUSE: 'https://news.google.com/rss/search?q=site:whitehouse.gov&hl=en-US&gl=US&ceid=US:en', // Broadened to site root for better hits
    USDT: 'https://news.google.com/rss/search?q=site:home.treasury.gov/news/press-releases&hl=en-US&gl=US&ceid=US:en', // Treasury Press Releases
};
