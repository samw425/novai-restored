...
// --- LATEST RELEASES (Updated for 2025 Context) ---
export const MASTER_VIDEO_DB: VideoItem[] = [
    {
        id: 'o1-building',
        ...
        category: "Analysis",
        aiScore: 99,
        timestamp: 1757678400000 // Sep 12, 2025
    },
    {
        id: 'o1-coding',
        ...
        category: "Demo",
        aiScore: 98,
        timestamp: 1757682000000 // Sep 12, 2025
    },
    {
        id: 'llama-3.2',
        ...
        category: "Launch",
        aiScore: 97,
        timestamp: 1758801600000 // Sep 25, 2025
    },
    {
        id: 'claude-3.5',
        ...
        category: "Launch",
        aiScore: 97,
        timestamp: 1750420800000 // Jun 20, 2025
    },
    {
        id: 'gpt-4o',
        ...
        category: "Demo",
        aiScore: 96,
        timestamp: 1747137600000 // May 13, 2025
    },
    {
        id: 'gemini-1.5',
        ...
        category: "Launch",
        aiScore: 95,
        timestamp: 1739620800000 // Feb 15, 2025
    },
    {
        id: 'sora',
    ...
    },
    {
        ...
        category: "Analysis",
        aiScore: 95,
        timestamp: 1742299200000 // Mar 18, 2025
    },
    {
        id: 'figure-01',
        ...
        source: "Figure",
        publishedAt: "Mar 13, 2025",
        duration: "02:35",
        views: "4.1M",
        category: "Demo",
        aiScore: 94,
        timestamp: 1741867200000 // Mar 13, 2025
    },
    {
        id: 'tesla-optimus',
        ...
        category: "Demo",
        aiScore: 92,
        timestamp: 1734091200000 // Dec 13, 2024
    },
    {
        id: 'apple-intelligence',
        title: "Apple Intelligence | WWDC 2025",
        ...
        category: "Launch",
        aiScore: 93,
        timestamp: 1749556800000 // Jun 10, 2025
    },
    {
        ...
        category: "Live",
        aiScore: 95,
        timestamp: 1760356800000 // Oct 13, 2025
    },
    {
        id: 'karpathy-llm-os',
...
// 30-Day Brief: Returns Top Rated videos from the last 12 months (extended window for quality)
export const get30DayBrief = (): VideoItem[] => {
    // Extended window to 12 months to ensure we capture major launches like GPT-4o and Claude 3.5
    ...
    return MASTER_VIDEO_DB.filter(video =>
        video.aiScore >= 90 &&
        video.timestamp >= twelveMonthsAgo
